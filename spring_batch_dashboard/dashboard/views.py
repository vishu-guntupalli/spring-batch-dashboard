...
__batch_resultset__ = ('jobName','jobInstanceId','jobStartTime','jobEndTime','jobStatus','keyName','keyDateValue','stepName',
...
def dashboard(request):
    ...
    for result_2 in rows:
        rowsDict = dict(zip(__batch_resultset__,result_2))
    ...
    return render(request, 'templates/index.html', {'all_jobs': formatted_results})
